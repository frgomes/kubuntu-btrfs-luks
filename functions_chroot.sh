...
function chroot_install_opensshd() {
  ...
  [[ -d "/home/${username}/.ssh" ]] || (mkdir -p "/home/${username}/.ssh"; chown -R ${username}:${username} /home/${username}/.ssh; chmod 700 "/home/${username}/.ssh" )
  [[ -f "/home/${username}/.ssh/id_ed25519" ]] || ssh-keygen -b 4096 -t ed25519 -a 5 -f "/home/${username}/.ssh/id_ed25519" -N"${user_password}"
}
...
EOD
  ...
  ##XXX DEBIAN_FRONTEND=noninteractive apt install -y firmware-linux
  update-grub
}
