...
#  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt setup_password_user
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_locales
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_btrfs_progs
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_kernel
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt create_fstab
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_grub
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt grub_enable_cryptodisk
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt configure_crypttab
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt configure_initramfs
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt configure_initramfs_tools
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt configure_networking
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_desktops
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_mozilla_suite
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_office_suite
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_printer_and_scanner
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt install_utilities
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt enable_services
  echo -n "PRESS ENTER"; read -s dummy
  chroot /mnt finish_installation
  echo -n "PRESS ENTER"; read -s dummy
